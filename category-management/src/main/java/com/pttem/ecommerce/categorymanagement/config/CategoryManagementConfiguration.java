package com.pttem.ecommerce.categorymanagement.config;
...
@Configuration
public class CategoryManagementConfiguration {
    private static final String BASE_PACKAGE = "com.pttem.ecommerce.categorymanagement";
    ...
    public Docket api() throws IOException, org.codehaus.plexus.util.xml.pull.XmlPullParserException {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(
                        RequestHandlerSelectors.basePackage("com.pttem.ecommerce.categorymanagement.controller"))
